...
#   value = <<CONFIGURATION
#     ssh -i "c1-key.pem" ubuntu@${aws_instance.consul[0].public_ip}
#     CONFIGURATION    
# }
...
#   value = <<CONFIGURATION
#     ssh -i "c1-key.pem" ubuntu@${aws_instance.hello_service.public_ip}
#     CONFIGURATION
# }
...
# output "ssh_to_mgw" {
#   value = <<CONFIGURATION
#   ssh -i "c1-key.pem" ubuntu@${aws_instance.mgw_service.public_ip}
#   CONFIGURATION
# }
