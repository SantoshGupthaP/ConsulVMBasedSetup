...
echo "Installing Promtail on Consul ESM $COUNT_INDEX..."
    ...
    static_configs:
      - targets:
        ...
        labels:
          ...
          hostname: $HOSTNAME
          private_ip: $PRIVATE_IP
          esm_instance_id: consul-esm-$COUNT_INDEX
...
[Unit]
Description=Promtail Log Collector for Consul ESM
...
echo "Promtail installation completed for Consul ESM $COUNT_INDEX"
