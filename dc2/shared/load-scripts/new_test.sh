...
register_service() {
    ...
    local j
    for j in $(seq 1 64); do # Use exactly 64 keys (the max)
...
for (( i=START_INDEX; i<=end_index; i++ )); do
  ...
  # --- FIX #2: Corrected arithmetic and added debugging output ---
  echo "=============================================================================="
  echo "DEBUG: BEFORE functions, main loop variable i = ${i}"
